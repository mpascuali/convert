function generateDatatable(tableId, columns, urlAjax, fnCallBack, paginate) {
       return $('#'+tableId).dataTable({
             "bPaginate": (paginate != null) ? paginate : true,
             "bFilter": (paginate != null) ? paginate : true,
             "aoColumns" : getColumns(columns),
             "bServerSide" : true,
             "bStateSave": true,
             "sAjaxSource" : urlAjax,
